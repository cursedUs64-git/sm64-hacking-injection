...
const LevelScript level_donjon_entry[] = {
    INIT_LEVEL(),
    LOAD_RAW(        /*seg*/ 0x07, _donjon_segment_7SegmentRomStart, _donjon_segment_7SegmentRomEnd),
    ...
    AREA(/*index*/ 1, RCP_Stage3Scene1),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 500, 2000, 0, /*angle*/ 1, 180, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvAirborneWarp),
