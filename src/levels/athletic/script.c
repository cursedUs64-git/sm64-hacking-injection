...
const LevelScript level_athletic_entry[] = {
    INIT_LEVEL(),
    LOAD_RAW(        /*seg*/ 0x07, _athletic_segment_7SegmentRomStart, _athletic_segment_7SegmentRomEnd),
    ...
    AREA(/*index*/ 1, RCP_Stage2Scene1),
        ...
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1000, 5000, 1000, /*angle*/ 1, 0, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvAirborneWarp),
        WARP_NODE(/*id*/ 0x0A, /*destLevel*/ LEVEL_UNKNOWN_2, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
